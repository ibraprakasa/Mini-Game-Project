...
function submit() {
  ...
  if (reg.test(document.getElementById("ans").value)){
    ...
    if (num != choice && counter < 7) {
      quote = "Yahh salah! Coba lagi 😀";

      if (num > choice) {
        hint = "Ia lebih besar dari " + choice;
      } 
      else if (num < choice) {
        hint = "Ia lebih kecil dari " + choice;
      }
    } 
    
    else if (num != choice && counter == 7) {
      document.getElementById("heading").innerHTML = "GAME BERAKHIR!!!";
      document.getElementById("heading2").innerHTML = "";
      quote = "Aku adalah " + num;
      ...
      document.getElementById("restart").innerHTML =
        ...
        ".svg' >" +
        "<p class='text-lg font-bold text-white'>Mulai Lagi</p>";
      flag = 2;
      play();
    } 
      ...
      quote = "SANTAI DULU GAK SIH (•ᴗ•)⸝🥂⸜(•ᴗ•)";
      document.getElementById("heading").innerHTML = "YUHUUU!";
      document.getElementById("heading2").innerHTML = "";
      document.getElementById("ans").type = "hidden";
      document.getElementById("submit").type = "hidden";
      document.getElementById("svg-cat").innerHTML =
